...
const char l_destination[5][20]={"PUNJAB","MUMBAI","GOA","KASHMIR","RAJASTHAN"};	//local Destination
const char i_destination[11][20]={"LONDON","BERLIN","DUBAI","RIYADH","BEIJING","PARIS","CANBERRA","TOKYO","WASHINGTON","DELHI","MUMBAI" }; //International Destination
...
int main()
{
	...
	system("COLOR 0F");
	cout<<"\n\t\tCOMPUTER PROGRAMMING LAB PROJECT\n\t\t  FLIGHT MANAGEMENT SYSTEM\nBY:\n1.AZMI (22SCSE1011371)\n2.KHUSHI DUBEY (22SCSE1011605)\n";
